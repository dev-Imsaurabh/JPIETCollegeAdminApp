...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private Button updateTeacherBtn,deleteTeacheBtn;
    private final int REQ=1;
    private Bitmap bitamap=null;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteTeacheBtn=findViewById(R.id.deleteTeacherBtn);
        ...
        deleteTeacheBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deleteData();
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        try {
            ...
            updateTeacherImage.setImageBitmap(bitamap);
        } catch (IOException e) {
            e.printStackTrace();
