...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImage=findViewById(R.id.addGalleryPhoto);
        ...
        String[] items= new String[]{"Select Category","College Album","Inceptra Pics","Other events"};
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        try {
            ...
            galleryImageView.setImageBitmap(bitamap);
        } catch (IOException e) {
            e.printStackTrace();
